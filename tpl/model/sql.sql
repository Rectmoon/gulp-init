CREATE TABLE IF NOT EXISTS `xxx_choose_zone` (
  ...
  PRIMARY KEY (`id`),
  KEY `uin` (`uin`)
) ENGINE=Innodb DEFAULT CHARSET=gbk COMMENT='�󶨴�����¼' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `xxx_present_log` (
  ...
  `present_id` varchar(32) NOT NULL COMMENT '���ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='��ȡ�����¼';
...
CREATE TABLE `xxx_lottery_chance` (
  ...
  `lottery_time` datetime DEFAULT NULL COMMENT '�齱ʱ��',
  PRIMARY KEY (`id`),
  KEY `uin` (`uin`)
